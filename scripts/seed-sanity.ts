  ...
  const testimonials = [
    {
      ...
      _type: 'testimonial',
      quote:
        'The Atelier transformed my nails into absolute works of art. The attention to detail and the serene atmosphere made it the most indulgent experience.',
      author: 'Sophie L.',
    ...
    },
    {
      ...
      _type: 'testimonial',
      quote:
        "My lash extensions have never looked better. The technicians here truly understand what suits each client's eyes perfectly.",
      author: 'Amelia R.',
    ...
    },
    {
      ...
      _type: 'testimonial',
      quote:
        'A sanctuary in the heart of the city. Every visit feels like an escape, and I leave looking and feeling my absolute best.',
      author: 'Jessica M.',
